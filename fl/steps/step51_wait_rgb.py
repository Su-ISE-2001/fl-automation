...
def get_detection_rectangle():
    """
    获取检测区域的矩形
    检测区域: (1197,211), (1209,212), (1196,220), (1212,222)
...
def main():
    """主函数 - 等待RGB变化并记录操作"""
    # 初始化GUI记录器
    output_file = "FL_step21_wait_rgb.json"
    recorder = GUIRecorder(output_file)
    
    print("\n" + "=" * 60)
    print("第二十一步：等待指定区域RGB变为目标值（记录操作）")
    print("=" * 60)
