...
def double_click_and_input_filename(input_x: int = None, 
    ...
    """
    print("=" * 60)
    print("第五十八步：双击文本输入框，输入基于时间的文件名")
    print("=" * 60)
...
def main():
    ...
    # 初始化GUI记录器
    output_file = "FL_step58_input_filename.json"
    recorder = GUIRecorder(output_file)
    
    print("\n" + "=" * 60)
    print("第五十八步：双击文本输入框，输入基于时间的文件名（记录操作）")
    print("=" * 60)
